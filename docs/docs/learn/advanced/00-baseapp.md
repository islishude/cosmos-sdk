...
`PrepareProposal` returns a response to the underlying consensus engine of type [`abci.ResponsePrepareProposal`](https://github.com/cometbft/cometbft/blob/v0.38.x/spec/abci/abci++_methods.md#processproposal). The response contains:
...
`ProcessProposal` returns a response to the underlying consensus engine of type [`abci.ResponseProcessProposal`](https://github.com/cometbft/cometbft/blob/v0.38.x/spec/abci/abci++_methods.md#processproposal). The response contains:
